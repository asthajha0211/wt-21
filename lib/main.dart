...
class _HomeState extends State<Home> {
  ...
  List<MyItem> items = <MyItem>[
    ...
    MyItem(
      header:
          "Q. Is it necessary for all participants to belong to the same university?",
      body:
    ...
    MyItem(
      ...
      body:
          "No. You need not ay any money to register yourself for any hackathon on HackerEarth.",
      hex: 0xffA41BE4,
      bodyhex: 0xff271231,
    ),
    MyItem(
    ...
    MyItem(
      header:
          "Q. I’m interested to participate but I am unable to find a team. What should I do?",
            ...
            onTap: () {
              showDialog(
                ...
                builder: (context) => CustomDialogBox(
                  ...
                  position:
                      'Data Science Consultant at Infinite-Sum Modeling Inc.',
                ),
              );
            },
            child: SpeakersCustom(
